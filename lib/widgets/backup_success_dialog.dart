...
///备份成功弹窗
class BackupSuccessDialog extends Dialog {
  ...
  static void showBackupSuccessDialog(BuildContext context) {
    if (!isShow) {
      isShow = true;
      showDialog(
          context: context,
          ...
          builder: (BuildContext context) {
            return BackupSuccessDialog();
          });
    }
  }

  static void hideBackupSuccessDialog(BuildContext context) {
    if (isShow) {
